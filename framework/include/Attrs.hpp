...
constexpr short ATTR_undefined = -1;
...
constexpr short ATTR_EVT_onmousedown = 34; const char * SATTR_EVT_onmousedown = "mousedown";
constexpr short ATTR_EVT_onmousemove = 35; const char * SATTR_EVT_onmousemove = "mousemove";
constexpr short ATTR_EVT_onmouseout = 36; const char * SATTR_EVT_onmouseout = "mouseout";
constexpr short ATTR_EVT_onmouseover = 37; const char * SATTR_EVT_onmouseover = "mouseover";
constexpr short ATTR_EVT_onmouseup = 38; const char * SATTR_EVT_onmouseup = "mouseup";
constexpr short ATTR_EVT_onmousewheel = 39; const char * SATTR_EVT_onmousewheel = "mousewheel";
constexpr short ATTR_EVT_onoffline = 40; const char * SATTR_EVT_onoffline = "offline";
constexpr short ATTR_EVT_ononline = 41; const char * SATTR_EVT_ononline = "online";
constexpr short ATTR_EVT_onpagehide = 42; const char * SATTR_EVT_onpagehide = "pagehide";
constexpr short ATTR_EVT_onpageshow = 43; const char * SATTR_EVT_onpageshow = "pageshow";
constexpr short ATTR_EVT_onpaste = 44; const char * SATTR_EVT_onpaste = "paste";
constexpr short ATTR_EVT_onpause = 45; const char * SATTR_EVT_onpause = "pause";
constexpr short ATTR_EVT_onplay = 46; const char * SATTR_EVT_onplay = "play";
constexpr short ATTR_EVT_onplaying = 47; const char * SATTR_EVT_onplaying = "playing";
constexpr short ATTR_EVT_onpointerover = 48; const char * SATTR_EVT_onpointerover = "pointerover";
constexpr short ATTR_EVT_onpointerdown = 50; const char * SATTR_EVT_onpointerdown = "pointerdown";
constexpr short ATTR_EVT_onpointermove = 51; const char * SATTR_EVT_onpointermove = "pointermove";
constexpr short ATTR_EVT_onpointerup = 52; const char * SATTR_EVT_onpointerup = "pointerup";
constexpr short ATTR_EVT_onpointercancel = 53; const char * SATTR_EVT_onpointercancel = "pointercancel";
constexpr short ATTR_EVT_onpointerout = 54; const char * SATTR_EVT_onpointerout = "pointerout";
constexpr short ATTR_EVT_onpointerrawupdate = 56; const char * SATTR_EVT_onpointerrawupdate = "pointerrawupdate";
constexpr short ATTR_EVT_onpopstate = 59; const char * SATTR_EVT_onpopstate = "popstate";
constexpr short ATTR_EVT_onprogress = 60; const char * SATTR_EVT_onprogress = "progress";
constexpr short ATTR_EVT_onratechange = 61; const char * SATTR_EVT_onratechange = "ratechange";
constexpr short ATTR_EVT_onreset = 62; const char * SATTR_EVT_onreset = "reset";
constexpr short ATTR_EVT_onsearch = 63; const char * SATTR_EVT_onsearch = "search";
constexpr short ATTR_EVT_onseeked = 64; const char * SATTR_EVT_onseeked = "seeked";
constexpr short ATTR_EVT_onseeking = 65; const char * SATTR_EVT_onseeking = "seeking";
constexpr short ATTR_EVT_onselect = 66; const char * SATTR_EVT_onselect = "select";
constexpr short ATTR_EVT_onstalled = 67; const char * SATTR_EVT_onstalled = "stalled";
constexpr short ATTR_EVT_onstorage = 68; const char * SATTR_EVT_onstorage = "storage";
constexpr short ATTR_EVT_onsubmit = 69; const char * SATTR_EVT_onsubmit = "submit";
constexpr short ATTR_EVT_onsuspend = 70; const char * SATTR_EVT_onsuspend = "suspend";
constexpr short ATTR_EVT_ontimeupdate = 71; const char * SATTR_EVT_ontimeupdate = "timeupdate";
constexpr short ATTR_EVT_ontoggle = 72; const char * SATTR_EVT_ontoggle = "toggle";
constexpr short ATTR_EVT_onvolumechange = 73; const char * SATTR_EVT_onvolumechange = "volumechange";
constexpr short ATTR_EVT_onwaiting = 74; const char * SATTR_EVT_onwaiting = "waiting";
constexpr short ATTR_EVT_onwheel = 75; const char * SATTR_EVT_onwheel = "wheel";
...
constexpr short ATTR_EVT_ongotpointercapture = 105; const char * SATTR_EVT_ongotpointercapture = "gotpointercapture";
constexpr short ATTR_EVT_onload = 106; const char * SATTR_EVT_onload = "load";
constexpr short ATTR_EVT_onlostpointercapture = 107; const char * SATTR_EVT_onlostpointercapture = "lostpointercapture";
constexpr short ATTR_EVT_onmouseenter = 108; const char * SATTR_EVT_onmouseenter = "mouseenter";
constexpr short ATTR_EVT_onmouseleave = 109; const char * SATTR_EVT_onmouseleave = "mouseleave";
constexpr short ATTR_EVT_onpointerenter = 110; const char * SATTR_EVT_onpointerenter = "pointerenter";
constexpr short ATTR_EVT_onpointerleave = 111; const char * SATTR_EVT_onpointerleave = "pointerleave";
constexpr short ATTR_EVT_onresize = 112; const char * SATTR_EVT_onresize = "resize";
constexpr short ATTR_EVT_onscroll = 113; const char * SATTR_EVT_onscroll = "scroll";
constexpr short ATTR_EVT_onunload = 114; const char * SATTR_EVT_onunload = "unload";
...
constexpr short ATTR_ariaselected = 211;
constexpr short ATTR_async = 212;
constexpr short ATTR_autocomplete = 213;
constexpr short ATTR_autofocus = 214;
constexpr short ATTR_autoplay = 215;
constexpr short ATTR_bgcolor = 216;
constexpr short ATTR_border = 217;
constexpr short ATTR_charset = 218;
constexpr short ATTR_checked = 219;
constexpr short ATTR_cite = 220;
constexpr short ATTR_classname = 221;
constexpr short ATTR_color = 222;
constexpr short ATTR_cols = 223;
constexpr short ATTR_colspan = 224;
constexpr short ATTR_content = 225;
constexpr short ATTR_contenteditable = 226;
constexpr short ATTR_controls = 227;
constexpr short ATTR_coords = 228;
constexpr short ATTR_data = 229;
constexpr short ATTR_datetime = 230;
constexpr short ATTR_defaultattr = 231;
constexpr short ATTR_defer = 232;
constexpr short ATTR_dir = 233;
constexpr short ATTR_dirname = 234;
constexpr short ATTR_disabled = 235;
constexpr short ATTR_download = 236;
constexpr short ATTR_draggable = 237;
constexpr short ATTR_dropzone = 238;
constexpr short ATTR_enctype = 239;
constexpr short ATTR_enterkeyhint = 240;
constexpr short ATTR_fill = 241;
constexpr short ATTR_forattr = 242;
constexpr short ATTR_form = 243;
constexpr short ATTR_formaction = 244;
constexpr short ATTR_headers = 245;
constexpr short ATTR_height = 246;
constexpr short ATTR_hidden = 247;
constexpr short ATTR_high = 248;
constexpr short ATTR_href = 249;
constexpr short ATTR_hreflang = 250;
constexpr short ATTR_httpequiv = 251;
constexpr short ATTR_icon = 252;
constexpr short ATTR_id = 253;
constexpr short ATTR_inert = 254;
constexpr short ATTR_inputmode = 255;
constexpr short ATTR_ismap = 256;
constexpr short ATTR_kind = 257;
constexpr short ATTR_label = 258;
constexpr short ATTR_lang = 259;
constexpr short ATTR_list = 260;
constexpr short ATTR_loop = 261;
constexpr short ATTR_low = 262;
constexpr short ATTR_max = 263;
constexpr short ATTR_maxlength = 264;
constexpr short ATTR_media = 265;
constexpr short ATTR_method = 266;
constexpr short ATTR_min = 267;
constexpr short ATTR_minlength = 268;
constexpr short ATTR_multiple = 269;
constexpr short ATTR_muted = 270;
constexpr short ATTR_name = 271;
constexpr short ATTR_novalidate = 272;
constexpr short ATTR_open = 273;
constexpr short ATTR_optimum = 274;
constexpr short ATTR_pattern = 275;
constexpr short ATTR_placeholder = 276;
constexpr short ATTR_popover = 277;
constexpr short ATTR_popovertarget = 278;
constexpr short ATTR_popovertargetaction = 279;
constexpr short ATTR_poster = 280;
constexpr short ATTR_preload = 281;
constexpr short ATTR_readonly = 282;
constexpr short ATTR_rel = 283;
constexpr short ATTR_required = 284;
constexpr short ATTR_reversed = 285;
constexpr short ATTR_role = 286;
constexpr short ATTR_rows = 287;
constexpr short ATTR_rowspan = 288;
constexpr short ATTR_sandbox = 289;
constexpr short ATTR_scope = 290;
constexpr short ATTR_selected = 291;
constexpr short ATTR_shape = 292;
constexpr short ATTR_size = 293;
constexpr short ATTR_sizes = 294;
constexpr short ATTR_span = 295;
constexpr short ATTR_spellcheck = 296;
constexpr short ATTR_src = 297;
constexpr short ATTR_srcdoc = 298;
constexpr short ATTR_srclang = 299;
constexpr short ATTR_srcset = 300;
constexpr short ATTR_start = 301;
constexpr short ATTR_step = 302;
constexpr short ATTR_style = 303;
constexpr short ATTR_tabindex = 304;
constexpr short ATTR_target = 305;
constexpr short ATTR_title = 306;
constexpr short ATTR_translate = 307;
constexpr short ATTR_type = 308;
constexpr short ATTR_usemap = 309;
constexpr short ATTR_value = 310;
constexpr short ATTR_viewbox = 311;
constexpr short ATTR_width = 312;
constexpr short ATTR_wrap = 313;
constexpr short ATTR_xmlns = 314;
// SGV
constexpr short ATTR_by = 600;
constexpr short ATTR_cx = 601;
constexpr short ATTR_cy = 602;
constexpr short ATTR_d = 603;
constexpr short ATTR_fillopacity = 604;
constexpr short ATTR_filter = 605;
constexpr short ATTR_floodcolor = 606;
constexpr short ATTR_floodopacity = 607;
constexpr short ATTR_fontsize = 608;
constexpr short ATTR_fontsizeadjust = 609;
constexpr short ATTR_fontstyle = 610;
constexpr short ATTR_fr = 611;
constexpr short ATTR_from = 612;
constexpr short ATTR_fx = 613;
constexpr short ATTR_fy = 614;
constexpr short ATTR_keypoints = 615;
constexpr short ATTR_keytimes = 616;
constexpr short ATTR_lengthadjust = 617;
constexpr short ATTR_letterspacing = 618;
constexpr short ATTR_lightingcolor = 619;
constexpr short ATTR_markerheight = 620;
constexpr short ATTR_markerunits = 621;
constexpr short ATTR_markerwidth = 622;
constexpr short ATTR_mask = 623;
constexpr short ATTR_numoctaves = 624;
constexpr short ATTR_opacity = 625;
constexpr short ATTR_operatorattr = 626;
constexpr short ATTR_orient = 627;
constexpr short ATTR_path = 628;
constexpr short ATTR_pathlength = 629;
constexpr short ATTR_patterncontentunits = 630;
constexpr short ATTR_patterntransform = 631;
constexpr short ATTR_patternunits = 632;
constexpr short ATTR_pointerevents = 633;
constexpr short ATTR_points = 634;
constexpr short ATTR_pointsatx = 635;
constexpr short ATTR_pointsaty = 636;
constexpr short ATTR_pointsatz = 637;
constexpr short ATTR_preservealpha = 638;
constexpr short ATTR_r = 639;
constexpr short ATTR_radius = 640;
constexpr short ATTR_repeatcount = 641;
constexpr short ATTR_repeatdur = 642;
constexpr short ATTR_requiredextensions = 643;
constexpr short ATTR_requiredfeatures = 644;
constexpr short ATTR_restart = 645;
constexpr short ATTR_rotate = 646;
constexpr short ATTR_rx = 647;
constexpr short ATTR_ry = 648;
constexpr short ATTR_scale = 649;
constexpr short ATTR_seed = 650;
constexpr short ATTR_shaperendering = 651;
constexpr short ATTR_specularexponent = 652;
constexpr short ATTR_specularconstant = 653;
constexpr short ATTR_startoffset = 654;
constexpr short ATTR_stddeviation = 655;
constexpr short ATTR_stitchtiles = 656;
constexpr short ATTR_stopcolor = 657;
constexpr short ATTR_stopopacity = 658;
constexpr short ATTR_strikethroughposition = 659;
constexpr short ATTR_strikethroughthickness = 660;
constexpr short ATTR_stroke = 661;
constexpr short ATTR_strokedasharray = 662;
constexpr short ATTR_strokedashoffset = 663;
constexpr short ATTR_strokelinecap = 664;
constexpr short ATTR_strokelinejoin = 665;
constexpr short ATTR_strokemiterlimit = 666;
constexpr short ATTR_strokeopacity = 667;
constexpr short ATTR_strokewidth = 668;
constexpr short ATTR_surfacescale = 669;
constexpr short ATTR_systemlanguage = 670;
constexpr short ATTR_tablevalues = 671;
constexpr short ATTR_textanchor = 672;
constexpr short ATTR_textdecoration = 673;
constexpr short ATTR_textrendering = 674;
constexpr short ATTR_textlength = 675;
constexpr short ATTR_to = 676;
constexpr short ATTR_transform = 677;
constexpr short ATTR_vectoreffect = 678;
constexpr short ATTR_visibility = 679;
constexpr short ATTR_wordspacing = 680;
constexpr short ATTR_writingmode = 681;
constexpr short ATTR_x = 682;
constexpr short ATTR_x1 = 683;
constexpr short ATTR_x2 = 684;
constexpr short ATTR_xchannelselector = 685;
constexpr short ATTR_xlinkhref = 686;
constexpr short ATTR_xmllang = 687;
constexpr short ATTR_y = 688;
constexpr short ATTR_y1 = 689;
constexpr short ATTR_y2 = 690;
constexpr short ATTR_ychannelselector = 691;
constexpr short ATTR_z = 692;
constexpr short ATTR_zoomandpan = 693;
...
inline const char* attrIdToName(short id) {
    switch (id) {
        ...
        case ATTR_EVT_onpointerover: return SATTR_EVT_onpointerover;
        case ATTR_EVT_onpointerdown: return SATTR_EVT_onpointerdown;
        case ATTR_EVT_onpointermove: return SATTR_EVT_onpointermove;
        case ATTR_EVT_onpointerup: return SATTR_EVT_onpointerup;
        case ATTR_EVT_onpointercancel: return SATTR_EVT_onpointercancel;
        case ATTR_EVT_onpointerout: return SATTR_EVT_onpointerout;
        case ATTR_EVT_onpointerrawupdate: return SATTR_EVT_onpointerrawupdate;
        ...
        case ATTR_EVT_ongotpointercapture: return SATTR_EVT_ongotpointercapture;
        case ATTR_EVT_onload: return SATTR_EVT_onload;
        case ATTR_EVT_onlostpointercapture: return SATTR_EVT_onlostpointercapture;
        case ATTR_EVT_onmouseenter: return SATTR_EVT_onmouseenter;
        case ATTR_EVT_onmouseleave: return SATTR_EVT_onmouseleave;
        case ATTR_EVT_onpointerenter: return SATTR_EVT_onpointerenter;
        case ATTR_EVT_onpointerleave: return SATTR_EVT_onpointerleave;
        ...
        case ATTR_ariaselected: return "aria-selected";
...
#define DEFINE_ATTR_HELPER(funcAttrName) \
    ...
    inline std::pair<short, std::string> funcAttrName##_if(bool a_bCondition, std::string a_sValue = "") { \
        if (!a_bCondition) { \
...
DEFINE_ATTR_HELPER(ariaselected)
...
DECLARE_EVENT_HELPER(onpointerover);
DECLARE_EVENT_HELPER(onpointerdown);
DECLARE_EVENT_HELPER(onpointermove);
DECLARE_EVENT_HELPER(onpointerup);
DECLARE_EVENT_HELPER(onpointercancel);
DECLARE_EVENT_HELPER(onpointerout);
DECLARE_EVENT_HELPER(onpointerrawupdate);
...
DECLARE_EVENT_HELPER(ongotpointercapture);
DECLARE_EVENT_HELPER(onload);
DECLARE_EVENT_HELPER(onlostpointercapture);
DECLARE_EVENT_HELPER(onmouseenter);
DECLARE_EVENT_HELPER(onmouseleave);
DECLARE_EVENT_HELPER(onpointerenter);
DECLARE_EVENT_HELPER(onpointerleave);
