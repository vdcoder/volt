...
constexpr short ATTR_EVT_onpopstate = 48; const char * SATTR_EVT_onpopstate = "popstate";
constexpr short ATTR_EVT_onprogress = 49; const char * SATTR_EVT_onprogress = "progress";
constexpr short ATTR_EVT_onratechange = 50; const char * SATTR_EVT_onratechange = "ratechange";
constexpr short ATTR_EVT_onreset = 51; const char * SATTR_EVT_onreset = "reset";
constexpr short ATTR_EVT_onsearch = 52; const char * SATTR_EVT_onsearch = "search";
constexpr short ATTR_EVT_onseeked = 53; const char * SATTR_EVT_onseeked = "seeked";
constexpr short ATTR_EVT_onseeking = 54; const char * SATTR_EVT_onseeking = "seeking";
constexpr short ATTR_EVT_onselect = 55; const char * SATTR_EVT_onselect = "select";
constexpr short ATTR_EVT_onstalled = 56; const char * SATTR_EVT_onstalled = "stalled";
constexpr short ATTR_EVT_onstorage = 57; const char * SATTR_EVT_onstorage = "storage";
constexpr short ATTR_EVT_onsubmit = 58; const char * SATTR_EVT_onsubmit = "submit";
constexpr short ATTR_EVT_onsuspend = 59; const char * SATTR_EVT_onsuspend = "suspend";
constexpr short ATTR_EVT_ontimeupdate = 60; const char * SATTR_EVT_ontimeupdate = "timeupdate";
constexpr short ATTR_EVT_ontoggle = 61; const char * SATTR_EVT_ontoggle = "toggle";
constexpr short ATTR_EVT_onvolumechange = 62; const char * SATTR_EVT_onvolumechange = "volumechange";
constexpr short ATTR_EVT_onwaiting = 63; const char * SATTR_EVT_onwaiting = "waiting";
constexpr short ATTR_EVT_onwheel = 64; const char * SATTR_EVT_onwheel = "wheel";
