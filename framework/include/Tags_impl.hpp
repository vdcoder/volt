...
inline const char* tagToString(ETag a_nTag) {
    switch (a_nTag) {
        ...
        // SVG
        case ETag::animate: return "animate";
        case ETag::animatemotion: return "animateMotion";
        case ETag::animatetransform: return "animateTransform";
        case ETag::circle: return "circle";
        case ETag::clippath: return "clipPath";
        case ETag::defs: return "defs";
        case ETag::desc: return "desc";
        case ETag::ellipse: return "ellipse";
        case ETag::feblend: return "feBlend";
        case ETag::fecolormatrix: return "feColorMatrix";
        case ETag::fecomponenttransfer: return "feComponentTransfer";
        case ETag::fecomposite: return "feComposite";
        case ETag::feconvolvematrix: return "feConvolveMatrix";
        case ETag::fediffuselighting: return "feDiffuseLighting";
        case ETag::fedisplacementmap: return "feDisplacementMap";
        case ETag::fedistantlight: return "feDistantLight";
        case ETag::fedropshadow: return "feDropShadow";
        case ETag::feflood: return "feFlood";
        case ETag::fefunca: return "feFuncA";
        case ETag::fefuncb: return "feFuncB";
        case ETag::fefuncg: return "feFuncG";
        case ETag::fefuncr: return "feFuncR";
        case ETag::fegaussianblur: return "feGaussianBlur";
        case ETag::feimage: return "feImage";
        case ETag::femerge: return "feMerge";
        case ETag::femergenode: return "feMergeNode";
        case ETag::femorphology: return "feMorphology";
        case ETag::feoffset: return "feOffset";
        case ETag::fepointlight: return "fePointLight";
        case ETag::fespecularlighting: return "feSpecularLighting";
        case ETag::fespotlight: return "feSpotLight";
        case ETag::fetile: return "feTile";
        case ETag::feturbulence: return "feTurbulence";
        case ETag::filter: return "filter";
        case ETag::foreignobject: return "foreignObject";
        case ETag::g: return "g";
        case ETag::image: return "image";
        case ETag::line: return "line";
        case ETag::lineargradient: return "linearGradient";
        case ETag::marker: return "marker";
        case ETag::mask: return "mask";
        case ETag::metadata: return "metadata";
        case ETag::mpath: return "mpath";
        case ETag::path: return "path";
        case ETag::pattern: return "pattern";
        case ETag::polygon: return "polygon";
        case ETag::polyline: return "polyline";
        case ETag::radialgradient: return "radialGradient";
        case ETag::rect: return "rect";
        case ETag::set: return "set";
        case ETag::stop: return "stop";
        case ETag::style: return "style";
        case ETag::switchtag: return "switch";
        case ETag::symbol: return "symbol";
        case ETag::text: return "text";
        case ETag::textpath: return "textPath";
        case ETag::tspan: return "tspan";
        case ETag::use: return "use";
        case ETag::view: return "view";
        default: return "div";
    }
}
